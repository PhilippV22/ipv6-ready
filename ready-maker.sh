...
echo "Do you want to setup NO-IP-DUC? (Y/n): $noipyn";
clear
echo "Do you want to setup Apache-DUC? (Y/n): $apacheyn";
clear
...
then
    ...
    clear
    echo "What is your E-Mail from NO-IP?: $noipemail";
    clear
    echo "What is your Password from NO-IP?: $noippassword";
    clear
    echo "What is the Domain that you want to update?: $noipdomain";
    clear
